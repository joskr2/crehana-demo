              ...
              <>
                {
                   infoDetail && infoDetail.name && (
                      <div className="max-w-sm rounded overflow-hidden shadow-lg">
                        <img className="w-full" src={`${infoDetail && infoDetail.flag && infoDetail.flag.svgFile}`} alt="country_flag" />
                      ...
                      <span className="bg-transparent text-black opacity-5 h-6 w-6 text-2xl block outline-none focus:outline-none">
                        ×
                                      ...
                                      <div className="relative p-6 flex-auto">
                                        ...
                                        <p className="text-gray-700 text-base">
                                          <strong>Densidad Poblacional: </strong> {infoDetail && infoDetail.populationDensity} por km²
                                        </p>
                                        <p className="text-gray-700 text-base">
                                          <strong>Nombre Nativo: </strong> {infoDetail && infoDetail.nativeName}
                                        </p>
                                        <p className="text-gray-700 text-base">
